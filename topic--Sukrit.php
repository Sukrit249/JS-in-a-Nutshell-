...
<div class="container">
  <div class="teaser">
    ...
    <h1>Operator</h1> 
    <!-- Teaser -->
    <p>I use the Operator to built a simple Calculator</p>
  </div>
      <!-- article -->
  <div class="article">
    <h2>A simple calculator</h2>
    <p>
    The num1 and num2 variabel are those two number that you add in.
    </p>
    <h3>Note</h3>
    <p>
    1. The first version of the code is link with a HTML tags <br>
